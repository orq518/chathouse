...
public class ChatConfig {
	// public static final String XMPP_HOST = "talk.google.com";
	// public static final String XMPP_SERVICE = "gmail.com";
	// public final static int XMPP_PORT = 5222;

	public static final String XMPP_HOST = "123.57.4.203";
	public static final String XMPP_SERVICE = "dev.tooony.com";
	public final static int XMPP_PORT = 5222;
	 ...
	 * sp请求信息
	 */
	public final static String SP_REQUEST_MESSAGE = "sp_request_message";
