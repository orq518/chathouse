...
import com.ouchat.util.TimeUtil;
...
public class RecentChatAdapter extends SimpleCursorAdapter {
	...
	private static final String[] FROM = new String[] {
			...
			ChatProvider.ChatConstants.DELIVERY_STATUS,  ChatProvider.ChatConstants.NICKNAME};// 查询字段
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (nickNameString!=null) {
			viewHolder.nameView.setText(nickNameString);
		}else {
			viewHolder.nameView.setText(XMPPHelper.splitJidAndServer(jid));
		}
