...
import com.ouchat.ui.switcher.Switch;
import com.ouchat.util.ChatConfig;
import com.ouchat.util.DialogUtil;
...
//			mFragmentCallBack.getMainActivity().updateRoster();
		...
		case R.id.notify_run_background_switch:
			PreferenceUtils.setPrefBoolean(getActivity(),
					ChatConfig.FOREGROUND, isChecked);
			break;
		case R.id.new_msg_sound_switch:
			PreferenceUtils.setPrefBoolean(getActivity(),
					ChatConfig.SCLIENTNOTIFY, isChecked);
			break;
		case R.id.new_msg_vibrator_switch:
			PreferenceUtils.setPrefBoolean(getActivity(),
					ChatConfig.VIBRATIONNOTIFY, isChecked);
			break;
		case R.id.new_msg_led_switch:
			PreferenceUtils.setPrefBoolean(getActivity(),
					ChatConfig.LEDNOTIFY, isChecked);
			break;
		case R.id.visiable_new_msg_switch:
			PreferenceUtils.setPrefBoolean(getActivity(),
					ChatConfig.TICKER, isChecked);
			break;
		case R.id.show_head_switch:
			PreferenceUtils.setPrefBoolean(getActivity(),
					ChatConfig.SHOW_MY_HEAD, isChecked);
			break;
		case R.id.connection_auto_switch:
			PreferenceUtils.setPrefBoolean(getActivity(),
					ChatConfig.AUTO_RECONNECT, isChecked);
			break;
		case R.id.poweron_receiver_msg_switch:
			PreferenceUtils.setPrefBoolean(getActivity(),
					ChatConfig.AUTO_START, isChecked);
			break;
		case R.id.send_crash_switch:
			PreferenceUtils.setPrefBoolean(getActivity(),
					ChatConfig.REPORT_CRASH, isChecked);
