...
public abstract class BaseService extends Service {
	...
	public IBinder onBind(Intent arg0) {
		Log.d("ouou", "called onBind()");
		return null;
	}

	@Override
	public boolean onUnbind(Intent intent) {
		Log.d("ouou", "called onUnbind()");
		return super.onUnbind(intent);
	}

	@Override
	public void onRebind(Intent intent) {
		Log.d("ouou",  "called onRebind()");
		super.onRebind(intent);
	}

	@Override
	public void onCreate() {
		Log.d("ouou",  "called onCreate()");
		super.onCreate();
	...
	public void onDestroy() {
		Log.d("ouou",  "called onDestroy()");
		super.onDestroy();
	}

	@Override
	public int onStartCommand(Intent intent, int flags, int startId) {
		Log.d("ouou",  "called onStartCommand()");
		return START_STICKY;
	}
	...
	protected void notifyClient(String fromJid, String fromUserName,
		...
		boolean vibraNotify = PreferenceUtils.getPrefBoolean(this,
				ChatConfig.VIBRATIONNOTIFY, true);
		if (vibraNotify) {
